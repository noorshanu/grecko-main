    ...
    <section className="  bg-about pt-8 pb-16">
      <div className="container-wrapper text-center block ">
        <div>
          ...
          <a href="https://t.me/grecko404" target="_blank" className=" bg-[#fff] hover:bg-black  text-black hover:text-white font-potta text-xl sm:text-xl rounded-full border-2 px-14 pt-1 pb-1 ">
           Telegram
         </a>
         <a href="https://twitter.com/Grecko404" target="_blank" className=" bg-[#fff] hover:bg-black  text-black hover:text-white font-potta text-xl sm:text-xl rounded-full border-2 px-14 pt-1 pb-1 ">
           Twitter
         </a>
          </div>
